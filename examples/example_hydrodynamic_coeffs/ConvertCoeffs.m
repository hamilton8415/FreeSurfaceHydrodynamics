...
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,1,1,AM_Inf(1,1),0.0);
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,1,5,AM_Inf(1,5),0.0);
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,2,2,AM_Inf(2,2),0.0);
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,2,4,AM_Inf(2,1),0.0);
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,3,3,AM_Inf(3,3),0.0);
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,4,2,AM_Inf(4,2),0.0);
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,4,4,AM_Inf(4,4),0.0);
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,5,1,AM_Inf(5,1),0.0);
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,5,5,AM_Inf(5,5),0.0);
fprintf(fid,"%.4f  %d  %d  %.5f  %.5f\n",0.0,6,6,AM_Inf(6,6),0.0);
